...
//        setData3();
    ...
    private void setData1(HashMap<String,Integer> dataHash1) {
        ...
        PieDataSet dataSet = new PieDataSet(entries, "기분 비");
    ...
    private void setData3(ArrayList<Float> dataKeys3, ArrayList<Integer> dataValues3) {
        ...
        LineDataSet set1 = new LineDataSet(entries, "월별 기분");
    ...
    public void loadStateData(){
        ...
        for (int  i = 0 ; i < recordCount ; i ++){
            cursor.moveToNext();
            String moodName = cursor.getString(cursor.getColumnIndex("MOOD"));
            int moodCount = cursor.getInt(cursor.getColumnIndex("COUNT(MOOD)"));
            AppConstants.println("FirstSet #"+i+" -> "+moodName + " , "+moodCount);
        ...
        for (int i = 0 ; i < recordCount ; i ++){
            ...
            AppConstants.println("Second Set #"+i+" -> "+monthDate +" , "+moodCount);
            recordHash.put(monthDate , moodCount);
        }
