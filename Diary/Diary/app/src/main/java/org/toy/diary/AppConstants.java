...
public class AppConstants {
    ...
    public static final int REQ_PERMISSION = 107;

    public static String FOLDER_PHOTO;
    public static String DATABASE_NAME = "note.db";

    public static final int MODE_INSERT = 101;
    public static final int MODE_MODIFY = 101;
    ...
    public static SimpleDateFormat dateFormat3 = new SimpleDateFormat("MM월dd");
